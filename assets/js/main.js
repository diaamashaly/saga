$(document).ready(function () {
  ...
  $("#nav-men").click(function () {
    $("#navbarNav").addClass("nav-go");
  });

  $(".men-cl").on("click", function () {
    $("#navbarNav").removeClass("nav-go");
    $(".nav-go").hide();
    $(".men-cl").hide();
  });
  ...
  //     );
  //     console.log(
  //       "%cThis is a protected website. Viewing or modifying the source code is prohibited.",
  //       "font-size: 16px;"
  //     );
  //   };
  ...
  //           "Developer tools detected. Please close them and refresh the page.";
  //       }
  //     }
